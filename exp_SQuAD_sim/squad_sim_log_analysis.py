...
def do_analysis_squad_sim(file_path, use_loss=False, stop=None):
    results = []
...
if __name__ == '__main__':
    file_path = '/Users/xxx/Desktop/tmp/file_transfer/squad_sim/Oct-16-23-05-44_log.txt'
    use_loss = False
    do_analysis_squad_sim(file_path, use_loss, 100000)
