...
from context_fusion.recurrent_models import contextual_bi_rnn
from context_fusion.SRU import bi_sru_recurrent_network
from context_fusion.CNN import cnn_for_context_fusion, cnn_for_sentence_encoding
from context_fusion.multi_head_attention import multi_head_attention, multi_head_attention_git
from context_fusion.integration_func import directional_attention_with_dense
from context_fusion.block_attention import bi_directional_simple_block_attention
from context_fusion.integration_func import multi_dimensional_attention
    ...
    with tf.variable_scope(scope or 'context_fusion_layers'):
        if method in ['lstm', 'gru', 'sru_normal']:
            ...
            context_fusion_output = multi_head_attention(
                rep_tensor, rep_mask, 8, sub_hn, 'ct_multi_head', is_train, keep_prob, wd)
